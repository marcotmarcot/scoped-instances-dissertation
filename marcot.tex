%% TODO:
%% * Implementação
%%   * Escrever sobre export
%%   * Escrever sobre teste do intermediate
%%   * Escrever sobre teste do import
%%   * Escrever sobre teste do export
%%   * Nome das instâncias
%%     * Testar
%%       * Escrever
%%     * Escrever
%% * Mencionar a crítica ao controle das instâncias em http://www.haskell.org/pipermail/glasgow-haskell-users/2010-August/019076.html
%% * Implicit conversions in Scala:
%%   * Página 448, os nomes são usados para importar e exportar
%%   * http://stackoverflow.com/questions/3079537/orphaned-instances-in-haskell#3079748, comentário do Matt
%% * Falar do sistema de módulo de Scala e ML
%% * Reforçar o argumento do Set, falando que isso já é possível, e colocar os
%%   e-mails como referência
%% * http://www.haskell.org/pipermail/haskell-cafe/2012-October/103855.html
%% * http://www.haskell.org/pipermail/libraries/2012-September/018398.html
